...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IBankMetadataApi
    {
        /// <summary>
        ...
        List<BankMetadata> GetMeta (Guid? requestId, Guid? xCorrelationId);
    }
    ...
    public class BankMetadataApi : IBankMetadataApi
    {
        ...
        /// <returns></returns>
        public BankMetadataApi(ApiClient apiClient = null)
        {
        ...
        /// <param name="xCorrelationId">An optional correlation ID for logging chain of events. If provided, it overrides the correlation ID generated by Blink Debit.</param>
        /// <returns>List&lt;BankMetadata&gt;</returns>
        public List<BankMetadata> GetMeta (Guid? requestId, Guid? xCorrelationId)
        {
 ...
 if (xCorrelationId != null) headerParams.Add("x-correlation-id", ApiClient.ParameterToString(xCorrelationId)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetMeta: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetMeta: " + response.ErrorMessage, response.ErrorMessage);
    
            return (List<BankMetadata>) ApiClient.Deserialize(response.Content, typeof(List<BankMetadata>), response.Headers);
        }
