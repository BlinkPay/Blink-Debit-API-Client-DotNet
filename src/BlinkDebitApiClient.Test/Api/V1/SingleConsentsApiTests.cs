...
namespace BlinkDebitApiClient.Test.Api.V1
{
    ...
    {
        private SingleConsentsApi instance;

        public SingleConsentsApiTests()
        {
            instance = new SingleConsentsApi();
        }
        ...
        {
            // TODO uncomment below to test 'IsType' SingleConsentsApi
            //Assert.IsType<SingleConsentsApi>(instance);
        }

        /// <summary>
        /// Test CreateSingleConsent
        /// </summary>
        [Fact]
        public void CreateSingleConsentTest()
        {
            ...
            //SingleConsentRequest? singleConsentRequest = null;
            //var response = instance.CreateSingleConsent(requestId, xCorrelationId, xCustomerIp, idempotencyKey, singleConsentRequest);
            //Assert.IsType<CreateConsentResponse>(response);
        }

        /// <summary>
        /// Test GetSingleConsent
        /// </summary>
        [Fact]
        public void GetSingleConsentTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid consentId = null;
            //Guid? requestId = null;
            //Guid? xCorrelationId = null;
            //var response = instance.GetSingleConsent(consentId, requestId, xCorrelationId);
            //Assert.IsType<Consent>(response);
        }

        /// <summary>
        /// Test RevokeSingleConsent
        /// </summary>
        [Fact]
        public void RevokeSingleConsentTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid consentId = null;
            //Guid? requestId = null;
            //Guid? xCorrelationId = null;
            //instance.RevokeSingleConsent(consentId, requestId, xCorrelationId);
        }
    }
}
