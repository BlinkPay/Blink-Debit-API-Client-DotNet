...
namespace BlinkDebitApiClient.Test.Api.V1
{
    ...
    {
        private QuickPaymentsApi instance;

        public QuickPaymentsApiTests()
        {
            instance = new QuickPaymentsApi();
        }
        ...
        {
            // TODO uncomment below to test 'IsType' QuickPaymentsApi
            //Assert.IsType<QuickPaymentsApi>(instance);
        }

        /// <summary>
        /// Test CreateQuickPayment
        /// </summary>
        [Fact]
        public void CreateQuickPaymentTest()
        {
            ...
            //QuickPaymentRequest? quickPaymentRequest = null;
            //var response = instance.CreateQuickPayment(requestId, xCorrelationId, xCustomerIp, idempotencyKey, quickPaymentRequest);
            //Assert.IsType<CreateQuickPaymentResponse>(response);
        }

        /// <summary>
        /// Test GetQuickPayment
        /// </summary>
        [Fact]
        public void GetQuickPaymentTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid quickPaymentId = null;
            //Guid? requestId = null;
            //Guid? xCorrelationId = null;
            //var response = instance.GetQuickPayment(quickPaymentId, requestId, xCorrelationId);
            //Assert.IsType<QuickPaymentResponse>(response);
        }

        /// <summary>
        /// Test RevokeQuickPayment
        /// </summary>
        [Fact]
        public void RevokeQuickPaymentTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid quickPaymentId = null;
            //Guid? requestId = null;
            //Guid? xCorrelationId = null;
            //instance.RevokeQuickPayment(quickPaymentId, requestId, xCorrelationId);
        }
    }
}
