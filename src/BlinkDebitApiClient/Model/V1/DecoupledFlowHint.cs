...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    /// Decoupled flow hint.
    /// </summary>
    [DataContract(Name = "decoupled-flow-hint")]
    public partial class DecoupledFlowHint : IEquatable<DecoupledFlowHint>, IValidatableObject
    {
        /// <summary>
        ...
        public DecoupledFlowHint(TypeEnum type = default(TypeEnum), Bank bank = default(Bank), IdentifierType identifierType = default(IdentifierType), string identifierValue = default(string))
        {
            this.Type = type;
            this.Bank = bank;
            ...
            {
                throw new ArgumentNullException("identifierValue is a required property for DecoupledFlowHint and cannot be null");
            }
        ...
        {
            return this.Equals(input as DecoupledFlowHint);
        }
