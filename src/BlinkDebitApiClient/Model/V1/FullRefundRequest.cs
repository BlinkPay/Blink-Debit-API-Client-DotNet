...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    /// </summary>
    [DataContract(Name = "full-refund-request")]
    public partial class FullRefundRequest : IEquatable<FullRefundRequest>, IValidatableObject
    {
        /// <summary>
        /// The refund type.
        /// </summary>
        ...
        public FullRefundRequest(Guid paymentId = default(Guid), TypeEnum type = default(TypeEnum), Pcr pcr = default(Pcr), string consentRedirect = default(string))
        {
            ...
            if (pcr == null)
            {
                throw new ArgumentNullException("pcr is a required property for FullRefundRequest and cannot be null");
            }
            this.Pcr = pcr;
        ...
        {
            return this.Equals(input as FullRefundRequest);
        }
