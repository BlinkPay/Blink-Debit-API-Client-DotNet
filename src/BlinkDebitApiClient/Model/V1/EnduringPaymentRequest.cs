...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    public partial class EnduringPaymentRequest : IEquatable<EnduringPaymentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public EnduringPaymentRequest(Pcr pcr = default(Pcr), Amount amount = default(Amount))
        {
            ...
            if (pcr == null)
            {
                throw new ArgumentNullException("pcr is a required property for EnduringPaymentRequest and cannot be null");
            }
            this.Pcr = pcr;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for EnduringPaymentRequest and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        {
            return this.Equals(input as EnduringPaymentRequest);
        }
