...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    public partial class GatewayFlow : AuthFlowDetail, IEquatable<GatewayFlow>, IValidatableObject
    {
        /// <summary>
        ...
        public GatewayFlow(string redirectUri = default(string), GatewayFlowAllOfFlowHint flowHint = default(GatewayFlowAllOfFlowHint), TypeEnum type = default(TypeEnum)) : base()
        {
            // to ensure "redirectUri" is required (not null)
            if (redirectUri == null)
            {
                throw new ArgumentNullException("redirectUri is a required property for GatewayFlow and cannot be null");
            }
        ...
        {
            return this.Equals(input as GatewayFlow);
        }
