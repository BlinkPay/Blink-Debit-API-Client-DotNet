...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    /// </summary>
    [DataContract(Name = "enduring-consent-request")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    public partial class EnduringConsentRequest : ConsentDetail, IEquatable<EnduringConsentRequest>, IValidatableObject
    {
        ...
        protected EnduringConsentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnduringConsentRequest" /> class.
        /// </summary>
        ...
        public EnduringConsentRequest(AuthFlow flow = default(AuthFlow), DateTime fromTimestamp = default(DateTime), DateTime expiryTimestamp = default(DateTime), Period period = default(Period), Amount maximumAmountPeriod = default(Amount), TypeEnum type = default(TypeEnum)) : base()
        {
            // to ensure "flow" is required (not null)
            if (flow == null)
            {
                throw new ArgumentNullException("flow is a required property for EnduringConsentRequest and cannot be null");
            }
            this.Flow = flow;
            ...
            {
                throw new ArgumentNullException("maximumAmountPeriod is a required property for EnduringConsentRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as EnduringConsentRequest);
        }
