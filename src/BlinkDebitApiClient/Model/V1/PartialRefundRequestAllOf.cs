...
namespace BlinkDebitApiClient.Model.V1
{
    ...
    public partial class PartialRefundRequestAllOf : IEquatable<PartialRefundRequestAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public PartialRefundRequestAllOf(Amount amount = default(Amount), Pcr pcr = default(Pcr), string consentRedirect = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PartialRefundRequestAllOf and cannot be null");
            }
            this.Amount = amount;
            // to ensure "pcr" is required (not null)
            if (pcr == null)
            {
                throw new ArgumentNullException("pcr is a required property for PartialRefundRequestAllOf and cannot be null");
            }
            this.Pcr = pcr;
        ...
        {
            return this.Equals(input as PartialRefundRequestAllOf);
        }
